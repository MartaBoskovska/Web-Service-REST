...
import web.hotel.repositories.ClientRepository2;
import web.hotel.repositories.OffreRepository2;
...
public class HotelController2 {
	...
	@Autowired
	ChambreRepository2 chambreRepo;
	@Autowired
	ReservationRepository2 resRepo;
	@Autowired
	AgenceRepository2 agenceRepo;
	@Autowired
	OffreRepository2 offreRepo;
	@Autowired
	ClientRepository2 clientRepo;
	
	private static final String uri = "hotelservice2/api";
